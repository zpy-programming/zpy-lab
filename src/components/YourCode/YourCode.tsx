...
import {configuration, languageDef} from "../../zpyEditor";
...
monaco.init().then(monaco => {
        ...
        monaco.languages.register({ id: 'zpy' })
        monaco.languages.setMonarchTokensProvider('zpy', languageDef)
        monaco.languages.setLanguageConfiguration('zpy', configuration)
